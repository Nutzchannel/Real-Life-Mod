...
public class RenderAdvancedFlame extends Render {
	...
	private ResourceLocation particleTextures = new ResourceLocation(
			"reallifemod:textures/Particles/Particles.png");
	private int f;
	...
	public void doRender(Entity entity, double p_76986_2_, double p_76986_4_,
		...
		this.renderFlame((EntityAdvancedFlameFX) entity, p_76986_2_,
				p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}

	private void renderFlame(EntityAdvancedFlameFX entity, double x, double y,
			double z, float rotationYaw, float rotationPitch) {
