...
public class BlockRenderer_Growpot implements ISimpleBlockRenderingHandler{

	final int renderID;
	private final growpotTE tile=new growpotTE();
	
	public BlockRenderer_Growpot(int var1){
		this.renderID=var1;
	}
