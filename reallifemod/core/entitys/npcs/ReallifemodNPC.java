...
public class ReallifemodNPC extends EntityAgeable implements INpc{
	public enum Job{
		BODYGUARD,DOCTOR,FIREMEN,POLICEMEN, MINOR, PEDESTRIAN;
	}
	public int jobIndex=0;
	public Job currentJob=Job.DOCTOR;
	...
	public ReallifemodNPC(World world,double d, double e,double f) {
		...
		this.setHealth(19);
        this.tasks.addTask(1, new EntityAIWander(this, 1.5D));
        ...
        this.tasks.addTask(7, new EntityAIAvoidEntity(this, EntityZombie.class, 8.0F, 0.6D, 0.6D));
	...
	public boolean interact(EntityPlayer player)
    {
    	...
    	case 0:
    		this.setJob(Job.BODYGUARD);
    		break;
    	case 1:
    		this.setJob(Job.DOCTOR);
    		break;
    	...
    	case 4:
    		this.setJob(Job.PEDESTRIAN);
    		break;
    	}
    	if(!player.worldObj.isRemote){
    		if(this.currentJob!=Job.DOCTOR){
