...
public class TLM_EventHandler 
{
	...
	public void onEntityConstructing(EntityConstructing event)
	{
		if(event.entity instanceof EntityPlayer){
			EntityPlayer entity=(EntityPlayer)event.entity;
		if (Minecraft.getMinecraft().thePlayer.getExtendedProperties("financialProps")== null){
			Minecraft.getMinecraft().thePlayer.registerExtendedProperties("financialProps", new financialProps(Minecraft.getMinecraft().thePlayer));
		}
		if (Minecraft.getMinecraft().thePlayer.getExtendedProperties("RealLifeProperties")== null){
			Minecraft.getMinecraft().thePlayer.registerExtendedProperties("RealLifeProperties", new RealLifeProperties(Minecraft.getMinecraft().thePlayer));
		}
		}
	}
