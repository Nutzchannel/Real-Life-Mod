...
public class BlockRenderer_Christmaspyramid implements ISimpleBlockRenderingHandler{

	final int renderID;
	private final christmaspyramidTE tile=new christmaspyramidTE();
	
	public BlockRenderer_Christmaspyramid(int var1){
		this.renderID=var1;
	}
	...
	public void render(Block block,int par0,float par2){
        if(block == TLMBlocks.christmaspyramid)
