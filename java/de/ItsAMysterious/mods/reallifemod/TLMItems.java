...
import de.ItsAMysterious.mods.reallifemod.core.items.itemCup;
...
public class TLMItems {
	...
	chips, ingotSteel, steelAxe, coke, Schrott, dirtySteel, emergencyHelicopter, Lowry, trailer,
	 ...
	 cupEmpty,cupCappuccino,cupCoffee, cupHotChocolate,cupLatte, cupEspresso,cupTea,noodlesoup;
	...
	public static void defineItems() {
		...
		itemList.add(dirtySteel = new Item().setCreativeTab(RealLifeMod.TLMIndustry).setTextureName("RealLifeMod:dirtySteel").setUnlocalizedName("dirtysteel"));
		...
		itemList.add(pillbox=new itemMed(0, false).setUnlocalizedName("pillbox").setTextureName("reallifemod:medicine").setCreativeTab(RealLifeMod.medicine));
