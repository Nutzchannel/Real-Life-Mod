...
public class itemTrailer extends Item implements Buyable{
	...
	public itemTrailer(){
		setUnlocalizedName("trailer");
		itemTrailer.mc=Minecraft.getMinecraft();
	}
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    EntityTrailer Trailer = new EntityTrailer(world, i + 0.5F, j + 1.0F, k + 0.5F);
                    ...
                    if (!world.isRemote)
                    {
                        world.spawnEntityInWorld(Trailer);
                    }
