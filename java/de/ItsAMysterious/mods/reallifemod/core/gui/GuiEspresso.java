	...
	public void actionPerformed(GuiButton button){
		...
		if(button.id==6){
			...
			if(Displaymessage=="Cappuccino"){
				player.inventory.addItemStackToInventory(new ItemStack(TLMItems.cupCappuccino));
			}
			if(Displaymessage=="Coffee"){
				player.inventory.addItemStackToInventory(new ItemStack(TLMItems.cupCoffee));
			}
			if(Displaymessage=="Hot Choc"){
				player.inventory.addItemStackToInventory(new ItemStack(TLMItems.cupHotChocolate));
			}
			if(Displaymessage=="Espresso"){
				player.inventory.addItemStackToInventory(new ItemStack(TLMItems.cupEspresso));
			}
			if(Displaymessage=="Latte"){
				player.inventory.addItemStackToInventory(new ItemStack(TLMItems.cupLatte));
			}
			if(Displaymessage=="Tea"){
			player.inventory.addItemStackToInventory(new ItemStack(TLMItems.cupTea));
			}
			}
