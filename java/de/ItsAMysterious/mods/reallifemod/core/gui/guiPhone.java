...
import de.ItsAMysterious.mods.reallifemod.api.entity.properties.RealLifeProps.phone.phonepartners;
...
public class guiPhone extends GuiScreen{
	...
	public void drawScreen(int x, int y,float f){
		...
		this.drawString(fontRendererObj, ((RealLifeProps)mc.thePlayer.getExtendedProperties("RealLifeProps")).ThePhone.partner.name(),(int)this.width/2-38,(int)(this.height/2)-30,Color.red.getRGB());
	}
	...
	public void actionPerformed(GuiButton button){
		...
		case 11:
			...
			if(numberField.getText()=="411"||numberField.getText()=="911"||numberField.getText()=="110")
				((RealLifeProps)mc.thePlayer.getExtendedProperties("RealLifeProps")).ThePhone.partner=phonepartners.POLICE;
			if(numberField.getText()=="411"||numberField.getText()=="911"||numberField.getText()=="110")
				((RealLifeProps)mc.thePlayer.getExtendedProperties("RealLifeProps")).ThePhone.partner=phonepartners.POLICE;
			}
		}
