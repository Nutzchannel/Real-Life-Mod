...
import de.ItsAMysterious.mods.reallifemod.core.renderers.blocks.models.ModelEspresso;
...
public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
	glPushMatrix(); 	
	    ...
	    this.bindTexture(new ResourceLocation("reallifemod:textures/tiles/espresso.png"));
