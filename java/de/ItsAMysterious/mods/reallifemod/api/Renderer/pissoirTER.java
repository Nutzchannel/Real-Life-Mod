...
public class pissoirTER extends TileEntitySpecialRenderer{
	...
	private ResourceLocation texture=new ResourceLocation("reallifemod:textures/blocks/indoor/WashPissoir.png");
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
    	GL11.glPushMatrix();
	        ...
	        int facing = ((pissoirTE) te).getFacingDirection();
	        int k = 0;
	        //South
	        if (facing == 2) {k = 180;}
	        //North
	        ...
	        this.bindTexture(new ResourceLocation("reallifemod:textures/blocks/indoor/Pissoir.png"));
	        model.renderAll();
        GL11.glPopMatrix();
    }
