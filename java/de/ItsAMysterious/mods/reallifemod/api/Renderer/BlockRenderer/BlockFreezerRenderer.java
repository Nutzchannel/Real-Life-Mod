...
public class BlockFreezerRenderer implements ISimpleBlockRenderingHandler{

	final int renderID;
	private final freezerTE tileFreezer=new freezerTE();
	
	public BlockFreezerRenderer(int var1){
		renderID=var1;
	}
