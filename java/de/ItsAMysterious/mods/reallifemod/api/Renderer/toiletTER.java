...
public class toiletTER extends TileEntitySpecialRenderer{
	private IModelCustom model, rotating;
	private ResourceLocation textures=new ResourceLocation("reallifemod:textures/blocks/everydaylife/toilet.png");    
	
	public toiletTER(){
		this.model=AdvancedModelLoader.loadModel(new ResourceLocation("reallifemod:models/everydaylife/toilets.obj"));
	}
