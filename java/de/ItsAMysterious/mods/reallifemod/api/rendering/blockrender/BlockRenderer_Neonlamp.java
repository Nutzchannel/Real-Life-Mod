...
public class BlockRenderer_Neonlamp implements ISimpleBlockRenderingHandler{

	final int renderID;
	private final neonlampTE tile=new neonlampTE();
	
	public BlockRenderer_Neonlamp(int var1){
		renderID=var1;
	}
