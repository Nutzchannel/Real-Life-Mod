...
public class BlockRenderer_Drinksmachine implements ISimpleBlockRenderingHandler{

	final int renderID;
	private final drinksmachineTE tile=new drinksmachineTE();
	
	public BlockRenderer_Drinksmachine(int var1){
		renderID=var1;
	}
	...
	public void render(Block block,int par0,float par2){
        if(block == TLMBlocks.DrinksMachine)
