...
public class BlockRenderer_Doorwreath implements ISimpleBlockRenderingHandler{

	final int renderID;
	private final doorwreathTE tile=new doorwreathTE();
	
	public BlockRenderer_Doorwreath(int var1){
		this.renderID=var1;
	}
	...
	public void render(Block block,int par0,float par2){
        if(block == TLMBlocks.BlockDoorwreath)
