...
public class TLMBlocks {
	...
	public static void defineBlocks(){
		...
		tlmBlockList.add(parquet=new ResourceBlock(Material.wood).setBlockName("parquet").setCreativeTab(RealLifeMod.Furniture).setBlockTextureName("reallifemod:parquet"));
