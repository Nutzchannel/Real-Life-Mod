...
public class EntityAdvancedFlameFX extends EntityFX
{
    ...
    public EntityAdvancedFlameFX(World p_i1209_1_, double p_i1209_2_, double p_i1209_4_, double p_i1209_6_, double p_i1209_8_, double p_i1209_10_, double p_i1209_12_)
    {
        ...
        double d6 = p_i1209_2_ + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;
        d6 = p_i1209_4_ + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;
        d6 = p_i1209_6_ + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;
